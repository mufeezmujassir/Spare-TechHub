...
public class DeleteProduct extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 private static final String IMAGE_DIRECTORY = "C:/Users/Acer/Desktop/Assignment/onlinespareparts/src/main/webapp/image/";   
    /**
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (Connection connection = ConnectionFactory.getConnection()) {
            ...
            String selectSQL = "SELECT image FROM product WHERE idproduct = ?";
            ...
            try (PreparedStatement deleteStatement = connection.prepareStatement(deleteSQL)) {
                ...
                if (rowsAffected > 0) {
                    // Step 3: Remove the image file from the server
