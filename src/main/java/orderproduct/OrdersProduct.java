...
/**
 * Servlet implementation class OrdersProduct
 */
public class OrdersProduct extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try(Connection connection=ConnectionFactory.getConnection();){
			try(PreparedStatement preparedStatement = connection.prepareStatement("select productid,pname,price, quantity, address, username,image from orders where username=?")){
